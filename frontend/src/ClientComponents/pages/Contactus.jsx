...
function Contactus() {
    ...
    return (
        <>
            ...
            <div className='lg:flex gap-5 lg:px-20 bg-slate-200 py-16'>
                <div className='flex justify-center items-center text-center pb-10  lg:w-1/2  font-nunito'>
                    <div className="p-4 w-3/4 lg:w-full bg-white shadow-lg rounded-lg">
                        <form className='md:p-10' onSubmit={handleSubmit}>
                            <div className='text-start py-5'>
                                <p className='text-green-500 font-medium text-2xl'>Have Questions</p>
                                <p className='text-gray-500 font-bold text-2xl md:text-3xl lg:text-4xl xl:text-5xl'>Send us a message</p>
                            </div>

                            <div className="mb-4 w-full">
                                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="name"></label>
                                <input
                                    className="bg-gray-100 appearance-none border rounded w-full py-3 lg:py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="name"
                                    type="text"
                                    name="name"
                                    placeholder="Name*"
                            ...
                            <div className='md:flex gap-8'>
                                <div className="mb-4 md:w-1/2 ">
                                    ...
                                    <input
                                        className="bg-gray-100 appearance-none border rounded w-full py-3 px-3 lg:py-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="email"
                                        type="email"
                                        name="email"
                                        placeholder="Email*"
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    className="bg-gray-100 appearance-none border rounded w-full py-3 pb-10 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="message"
                                    name="message"
                            ...
                            <div className="flex justify-start">
                                <button
                                    className="bg-blue-950 hover:bg-green-600 w-full flex text-center justify-center gap-2 items-center text-white hover:text-black font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline"
                                    type="submit"
                                >
                                    <FaPaperPlane />
                                    Get in Touch
