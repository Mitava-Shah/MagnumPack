    ...
    return (
        <div className='p-4 py-10 mb-16'>
            <div className='flex items-center justify-center py-5'>
                <p className='text-5xl font-cursive font-bold bg-clip-text text-transparent bg-center bg-cover bg-fixed bg-[url("https://images.pexels.com/photos/5908654/pexels-photo-5908654.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")]'>
                    {heading}
                </p>
            </div>
            <Slider {...settings}>
                {achievements.map((product, index) => (
                    <div key={index} className='px-8 pb-24 pt-14'>
                        <div className='relative flex justify-center items-center text-center shadow-md '>
                            ...
                            <div className='absolute -bottom-20 w-2/3 p-5 bg-white shadow-xl rounded-lg'>
                                <div className='flex items-center justify-center overflow-auto'>
                                    <span className='block w-1/4 h-px bg-green-500 mx-2'></span>
                                    <p className='text-lg font-medium text-green-500'>{product.title}</p>
                                    <span className='block w-1/4 h-px bg-green-500 mx-2'></span>
                                </div>
                            </div>
                        </div>
