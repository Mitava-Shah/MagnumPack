    ...
    return (
        <div className='md:mx-16 flex flex-col md:flex-row '>
            <div className='flex flex-col  mb-8 w-full md:w-1/3'>
                <p className='text-5xl mb-8 mt-8text-5xl font-bold bg-clip-text text-transparent bg-center bg-cover bg-fixed bg-[url("https://images.pexels.com/photos/5908654/pexels-photo-5908654.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")] font-cursive text-center md:text-left' >{heading}</p>
