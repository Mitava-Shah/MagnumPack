  ...
  return (
    <div className='  lg:pb-10 w-full relative pb-16 overflow-hidden'>
      ...
      <div className='flex flex-col justify-center items-center mb-10 mt-10 lg:mx-[16rem]'>
        <p className='text-xl md:text-2xl lg:text-3xl xl:text-4xl md:mx-[8rem] xl:mx-[15rem] lg:mx-0  text-center font-bold text-transparent bg-clip-text bg-[url("https://images.pexels.com/photos/5908654/pexels-photo-5908654.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")] bg-left font-cursive bg-fixed '>{heading}</p>
      </div>
