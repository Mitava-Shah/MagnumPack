      ...
      <div className='flex flex-col xl:flex-row justify-center items-center gap-8 xl:mx-16 mb-16' ref={componentRef}>
        ...
        <div className='flex flex-col md:flex-row xl:flex-col gap-8 mx-2 md:mx-8 xl:mx-2'>
          {whuChooseUs.slice(0, 2).map((item) => (
            <div key={item.id} className='flex flex-col md:flex-row md:justify-start md:items-start justify-center items-center gap-4 md:gap-2 md:border-b-0 xl:border-b border-b border-b-green-500 pb-8 md:pb-0 xl:pb-8'>
        ...
        <div className='flex flex-col md:flex-row xl:flex-col gap-8 mx-2 md:mx-8 xl:mx-2'>
          {whuChooseUs.slice(2, 4).map((item) => (
            <div key={item.id} className='flex flex-col md:flex-row xl:flex-row-reverse md:justify-start md:items-start justify-center items-center gap-4 md:gap-2 md:border-b-0 border-b xl:border-b border-b-green-500 pb-8 md:pb-0 xl:pb-8'>
              <img src={`/api/image/download/${item.photo[0]}`} alt={item.alt} title={item.imgTitle} className='w-16 h-16' />
              <div className=' flex flex-col justify-center items-center md:justify-start md:items-start gap-4 '>
                <p className='font-bold text-[25px]'>
                  {item.title}
