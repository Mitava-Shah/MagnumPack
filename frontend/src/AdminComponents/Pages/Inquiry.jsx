...
/api/inquiries/getInquiries`, { withCredentials: true });
...
/api/inquiries/deleteInquiry?id=${id}`, { withCredentials: true });
      ...
      <div className="flex justify-between mt-8">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none focus:border-blue-500 transition duration-300"
          >
