...
/api/product/getAllProducts?page=${pageIndex + 1}`, { withCredentials: true });
  ...
  const deleteProduct = async (slugs) => {
    try {
      await axios.delete(`
/api/product/deleteProduct?slugs=${slugs}`, { withCredentials: true });
      ...
      <div className="flex md:flex-row flex-col justify-between md:items-center mb-4">
        ...
        <div className="flex gap-2 md:flex-row flex-col md:mt-0 mt-4">
          <div className="flex items-center gap-2">
            ...
            <Link to="/product/createProduct" className="px-4 py-2 bg-slate-700 text-white rounded hover:bg-slate-900 transition duration-300" title="Add">
              <FaPlus size={15} />
            </Link>
