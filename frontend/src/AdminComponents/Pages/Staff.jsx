...
/api/image/download/${firstImage}`} alt="Service" className="w-32 h-20 object-cover" /> : null;
...
/api/staff/getStaff?page=${pageIndex + 1}`, { withCredentials: true });
...
/api/staff/deleteStaff?id=${id}`, { withCredentials: true });
