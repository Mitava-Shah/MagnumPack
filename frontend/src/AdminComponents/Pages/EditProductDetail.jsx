...
/api/productDetail/getProductDetailById?id=${productId}`, { withCredentials: true });
            ...
            setProductId(productDetail.productId._id);
            setProductTitle(productDetail.productId.title)
        } catch (error) {
            console.error(error);
        }
    };
...
/api/productDetail/updateProductDetail?id=${id}`, formData, {
                headers: {
