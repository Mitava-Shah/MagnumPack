...
const EditNews = () => {
  ...
  const fetchNews = async () => {
    try {
      ...
      news.url ? setUrl(news.url) : setUrl(`https://demo.rndtechnosoft.com/news/${news.slug}`)
  ...
  useEffect(() => {
    if (slug) {
      setUrl(`https://demo.rndtechnosoft.com/blog/${slug}`);
    }
  }, [slug]);
    ...
    <form onSubmit={handleSubmit} className="p-4">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          type="url"
          id="url"
          value={`https://demo.rndtechnosoft.com/news/${slug}`}
          className="w-full p-2 border rounded focus:outline-none"
        />
      </div>
      <div className="mb-4">
