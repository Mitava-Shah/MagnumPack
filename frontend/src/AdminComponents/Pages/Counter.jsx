  ...
  const columns = useMemo(
    () => [
      ...
      // },
      {
        ...
        Cell: ({ value }) => {
          return <img src={`
/api/logo/download/${value}`} alt="counter" className=" w-fit h-20" />;
...
/api/counter/getCounter`, { withCredentials: true });
...
/api/counter/deleteCounter?id=${id}`, { withCredentials: true });
      fetchData();
    } catch (error) {
      console.error(error);
    }
