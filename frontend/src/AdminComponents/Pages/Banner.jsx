...
/api/image/download/${firstImage}`} alt="Banner" className="w-32 h-20 object-cover" /> : null;
        },
        disableSortBy: true,
      },
      {
...
/api/banner/getBanner?page=${pageIndex + 1}`, { withCredentials: true });
    ...
    <div className="p-4 overflow-x-auto">
      ...
      <div className="mb-4 flex">
        ...
        >
          ...
          <option value="Products">Latest Blogs</option>
          <option value="Services">Customize Packaging</option>
        </select>
      </div>
      {
        loadings ? (
