...
/api/productinquiry/getproductinquiries`, { withCredentials: true });
...
/api/productinquiry/deleteinquiries?id=${id}`, { withCredentials: true });
      fetchData();
    } catch (error) {
      console.error(error);
    }
  ...
  return (
    <div className="p-4 overflow-x-auto">
      <h1 className="text-xl font-bold text-gray-700 font-serif uppercase mb-4">Product Inquiries</h1>
      <div className="mb-4">
        <input
          type="text"
