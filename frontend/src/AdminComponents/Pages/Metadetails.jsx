  ...
  const fetchData = async () => {
    ...
    try {
      const [
        ...
        axios.get(`
/api/sitemap/fetchSitemaps`, { withCredentials: true }),
        axios.get(`
/api/product/fetchUrlmeta`, { withCredentials: true }),
        axios.get(`
/api/product/fetchCategoryUrlmeta`, { withCredentials: true }),
        axios.get(`
/api/news/fetchUrlmeta`, { withCredentials: true }),
        axios.get(`
/api/news/fetchCategoryUrlmeta`, { withCredentials: true }),
      ]);
