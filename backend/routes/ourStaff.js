...
const { insertStaff, getStaff, updateStaff,getActiveStaff, deleteStaff , getStaffById ,countStaff,deletePhotoAndAltText} = require('../controller/ourStaff');
...
router.get('/getActiveStaff', getActiveStaff);
