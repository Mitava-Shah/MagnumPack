...
const {insertTestimonial, getTestimonials,getActiveTestimonials, updateTestimonial,deleteTestimonial, getTestimonialById,countTestimonial,deletePhotoAndAltText} = require('../controller/testimonial');
