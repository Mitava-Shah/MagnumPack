...
const insertCategory = async (req, res) => {
  ...
  try {
    ...
    const newCategory = new NewsCategory({ category, photo, alt, imgTitle, slug, metatitle, metadescription, metakeywords, metacanonical, metalanguage, metaschema, otherMeta, url, priority, changeFreq });
...
const insertSubSubCategory = async (req, res) => {
  ...
  try {
    ...
    subCategory.subSubCategory.push({ category, photo, alt, imgTitle, slug, metatitle, metadescription, metakeywords, metacanonical, metalanguage, metaschema, otherMeta, url, priority, changeFreq });
    await categoryDoc.save();
...
const updateCategory = async (req, res) => {
  ...
  try {
    const updatedCategory = await NewsCategory.findByIdAndUpdate(
      categoryId,
      { category, photo, alt, imgTitle, slug, metatitle, metadescription, metakeywords, metacanonical, metalanguage, metaschema, otherMeta, url, priority, changeFreq },
