...
exports.generateMainSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath = path.join(__dirname, '..', 'build', 'sitemap-main.xml');
...
exports.generateProductSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath = path.join(__dirname, '..', 'build', 'sitemap-product.xml');
...
exports.generateServiceSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath = path.join(__dirname, '..', 'build', 'sitemap-service.xml');
...
exports.generateNewsSitemap = async (req, res) => {
  ...
  try {
    ...
    const sitemapPath =  path.join(__dirname, '..', 'build', 'sitemap-blog.xml');
...
exports.generateSitemapIndex = async (req, res) => {
  try {
    const sitemaps = [
      { url: 'https://demo.rndtechnosoft.com/sitemap-main.xml' },
      { url: 'https://demo.rndtechnosoft.com/sitemap-product.xml' },
      { url: 'https://demo.rndtechnosoft.com/sitemap-news.xml' },
    ];
