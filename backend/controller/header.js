...
exports.updateHeader = async (req, res) => {
  try {
    const { phoneNo, openingHours, facebooklink, twitterlink, youtubelink, linkedinlink } = req.body;
    ...
    header.facebooklink = facebooklink;
    header.twitterlink = twitterlink;
    header.youtubelink = youtubelink;
    header.linkedinlink = linkedinlink
