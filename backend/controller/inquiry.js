...
<body>
    <div class="container">
        ...
        <p><span class="field">Product Name:</span> ${newInquiry.name}</p>
        <p><span class="field">Name:</span> ${newInquiry.email}</p>
        <p><span class="field">Email:</span> ${newInquiry.phone}</p>
        <p><span class="field">Phone:</span> ${newInquiry.message}</p>
